...
public class dramaActivity extends AppCompatActivity implements allMoviesAdapter.onClick{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.rv_drama);

        MovieDatabase db = new MovieDatabase(this);


        allMoviesAdapter myAdapter = new allMoviesAdapter(this,db.getMovieByGenre("Drama"), this);
    ...
    public void onBuyButtonClick(Movie movie) {
        Intent intent = new Intent(dramaActivity.this, PaymentActivity.class);
