...
public class AllMoviesActivity extends AppCompatActivity implements allMoviesAdapter.onClick {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.rv_allMovies);

        db = new MovieDatabase(this);


        allMoviesAdapter myAdapter = new allMoviesAdapter(this,db.getAllMovies(), this);
    ...
    public void onBuyButtonClick(Movie movie) {
        Intent intent = new Intent(AllMoviesActivity.this, PaymentActivity.class);
