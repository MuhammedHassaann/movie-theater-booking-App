...
public class scienceFictionActivity extends AppCompatActivity implements allMoviesAdapter.onClick {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.rv_scienceFiction);

        MovieDatabase db = new MovieDatabase(this);


        allMoviesAdapter myAdapter = new allMoviesAdapter(this,db.getMovieByGenre("Science Fiction"), this);
    ...
    public void onBuyButtonClick(Movie movie) {
        Intent intent = new Intent(scienceFictionActivity.this, PaymentActivity.class);
