...
public class animationActivity extends AppCompatActivity implements allMoviesAdapter.onClick {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.rv_animation);

        MovieDatabase db = new MovieDatabase(this);


        allMoviesAdapter myAdapter = new allMoviesAdapter(this,db.getMovieByGenre("Animation"), this);
    ...
    public void onBuyButtonClick(Movie movie) {
        Intent intent = new Intent(animationActivity.this, PaymentActivity.class);
