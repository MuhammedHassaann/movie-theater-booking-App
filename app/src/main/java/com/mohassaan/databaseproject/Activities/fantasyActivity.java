...
public class fantasyActivity extends AppCompatActivity implements allMoviesAdapter.onClick{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.rv_fantasy);

        MovieDatabase db = new MovieDatabase(this);


        allMoviesAdapter myAdapter = new allMoviesAdapter(this,db.getMovieByGenre("Fantasy"), this);
