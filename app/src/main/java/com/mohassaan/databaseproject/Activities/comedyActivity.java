...
public class comedyActivity extends AppCompatActivity implements allMoviesAdapter.onClick{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.rv_comedy);

        MovieDatabase db = new MovieDatabase(this);


        allMoviesAdapter myAdapter = new allMoviesAdapter(this,db.getMovieByGenre("Comedy"), this);
    ...
    public void onBuyButtonClick(Movie movie) {
        Intent intent = new Intent(comedyActivity.this, PaymentActivity.class);
